            ...
            <div class="auth-box bg-dark border-top border-secondary">
                <div id="loginformm">
                    <div class="text-center p-t-20 p-b-20">
                        <span class="db"><img src="public/master/assets/images/logo.png" alt="logo" /></span>
                    </div>
                    <!-- Form -->
                            ...
                            <div class="col-12">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control form-control-lg" placeholder="Username"
                                        aria-label="Username" aria-describedby="basic-addon1" required="" id="username">
                                </div>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <div class="p-t-20">
                                        ...
                                        <input class="btn btn-success float-right" type="submit" value="Submit" id="btn_login">
                                    </div>
                                </div>
                            </div>
                        </div>

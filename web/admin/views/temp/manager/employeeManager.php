            ...
            <div class="row" style="margin-bottom: 2%;">
                <div class="col-4">
                    ...
                    <button type="button" class="btn btn-success btn-lg" data-toggle="modal"
                        ...
                        <a href="Manager/exportMember?level=3"><button type="button" class="btn btn-warning btn-lg" data-toggle="modal"
            ...
            <div class="modal fade show" id="addUserfromCsv" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="POST" enctype="multipart/form-data" action="Manager/importMember?level=3">
                                <div class="form-group">
                                ...
                                <table id="zero_config" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <th>
                                                <a href="Manager/modifyMember?id=<?php echo $value->id; ?>&level=<?php echo 3; ?>" ><button type="button" class="<?php if (!empty($data['model']->readAccount($value->id,3))){
                                                    if ($data['model']->readAccount($value->id,3)->status == 1){
                                                ...
                                                } ?>"><i class="<?php if (!empty($data['model']->readAccount($value->id,3))){
                                                    if ($data['model']->readAccount($value->id,3)->status == 1){
                                                    echo "mdi mdi-lock";
                                                    } else {
                                                ...
                                                <a href="Manager/removeMember?id=<?php echo $value->id; ?>&level=<?php echo 3; ?>" ><button type="button" class="btn btn-danger"><i class="mdi mdi-window-close"></i></button></a>
                                            </th>
                                        </tr>
                                        <?php } ?>
                                    </tbody>

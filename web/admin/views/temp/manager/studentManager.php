        ...
        <div class="page-breadcrumb">
            <div class="row">
                <div class="col-12 d-flex no-block align-items-center">
                    <h4 class="page-title">Student Manager Account</h4>
            ...
            <div class="row">
                <div class="col-4" style="margin-bottom: 2%;">
                    ...
                    <button type="button" class="btn btn-success btn-lg" data-toggle="modal"
                        ...
                        <a href="Manager/export"><button type="button" class="btn btn-warning btn-lg" data-toggle="modal"
            ...
            <div class="modal fade show" id="addUserfromCsv" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="POST" enctype="multipart/form-data" action="Manager/import">
                                <div class="form-group">
                                ...
                                <table id="zero_config" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <th><?php echo $value->class_name; ?></th>
                                            <th>
                                                <a href="Manager/modifyMember?id=<?php echo $value->id; ?>&level=<?php echo 1; ?>" ><button type="button" class="<?php if (!empty($data['model']->readAccount($value->id,1))){
                                                    if ($data['model']->readAccount($value->id,1)->status == 1){
                                                ...
                                                } ?>"><i class="<?php if (!empty($data['model']->readAccount($value->id,1))){
                                                    if ($data['model']->readAccount($value->id,1)->status == 1){
                                                    echo "mdi mdi-lock";
                                                    } else {
                                                ...
                                                <a href="Manager/removeMember?id=<?php echo $value->id; ?>&level=<?php echo 1; ?>" ><button type="button" class="btn btn-danger"><i class="mdi mdi-window-close"></i></button></a>
                                            </th>
                                        </tr>
                                        <?php } ?>
                                    </tbody>

                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-sub-header">
                            <h3 class="page-title">Welcome <?php if (isset($data['user']->full_name)){echo $data['user']->full_name; } else {echo "Admins"; } ?></h3>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="https://preschool.dreamguystech.com/template/index.html">Home  / Teacher</a></li>
                    ...
                    <div class="card bg-comman w-100">
                        <div class="card-body">
                            <div class="db-widgets d-flex justify-content-between align-items-center">
                                ...
                                <div class="db-icon">
                                    <img src="https://preschool.dreamguystech.com/template/assets/img/icons/teacher-icon-01.svg"
                                        alt="Dashboard Icon">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card bg-comman w-100">
                        <div class="card-body">
                            <div class="db-widgets d-flex justify-content-between align-items-center">
                                ...
                                <div class="db-icon">
                                    <img src="https://preschool.dreamguystech.com/template/assets/img/icons/dash-icon-01.svg"
                                        alt="Dashboard Icon">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card bg-comman w-100">
                        <div class="card-body">
                            <div class="db-widgets d-flex justify-content-between align-items-center">
                                ...
                                <div class="db-icon">
                                    <img src="https://preschool.dreamguystech.com/template/assets/img/icons/teacher-icon-03.svg"
                                        alt="Dashboard Icon">
                                </div>
                            </div>
                        </div>

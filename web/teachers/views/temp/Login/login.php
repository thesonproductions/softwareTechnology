...
<body>
    ...
    <script src="public/master/assets/js/jquery-3.6.0.min.js" type="text/javascript"></script>

    <script src="public/master/assets/plugins/bootstrap/js/bootstrap.bundle.min.js" type="text/javascript"></script>

    <script src="public/master/assets/js/feather.min.js" type="text/javascript"></script>

    <script src="public/master/assets/js/script.js" type="text/javascript"></script>
    <script src="vendors/swal/sweetalert2.all.min.js" type="text/javascript"></script>
</body>
<script>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.status === 1) {
                        ...
                        $('#form_error').css('color', 'green')
                        $('#form_error').html('<p>' + response.message + '</p>')
                        Swal.fire({
                            icon: 'success',
                        ...
                        $('#form_error').css('display', 'block')
                        $('#form_error').css('color', 'orange')
                        $('#form_error').html('<p>' + response.message + '</p>')
                        Swal.fire({
                            icon: 'error',
                            title: 'Unknown account or incorrect password',
                            text: 'Something went wrong!',
                            footer: '<a href="">Why do I have this issue?</a>',
                        })
                    }
